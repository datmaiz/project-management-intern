...
function calculatePermissions(role: Role): Record<ProjectAction, boolean> {
	...
	const permissions: Record<Role, ProjectAction[]> = {
		owner: [...manageProject, ...manageSettings, ...manageMembers, ...manageTasks],
		admin: [
			ProjectAction.CLOSE_PROJECT,
			ProjectAction.UPDATE_PROJECT,
			...manageSettings,
		...
		read: [ProjectAction.VIEW_OPTIONS, ProjectAction.VIEW_MEMBERS, ProjectAction.VIEW_TASKS, ProjectAction.MOVE_TASKS],
	}
