...
import { defaultLabels, defaultPriorities, defaultSizes, defaultStatuses } from '@/consts/default-options'
...
export const CreateProjectModal = ({ projectDetails }: Props) => {
	...
	const handleAddNewOptionItem = (data: Omit<ICustomFieldData, 'id'>, state: CustomFieldDBTableName) => {
		switch (state) {
			case 'sizes':
	...
	return (
		...
		>
			...
			<DialogContent className='md:min-w-[90%] lg:min-w-[70%] max-h-screen overflow-auto'>
				...
				<DialogDescription>Customize default options for your project.</DialogDescription>
				<Separator />
					...
					<CustomFieldOptions
						...
						embeddedCreateOptionEle={
							<CreateCustomFieldOptionModal
								...
								handleSubmit={data => handleAddNewOptionItem(data, 'priorities')}
								triggerBtn={AddNewOptionBtn}
								action='create-new-project'
							/>
						}
					...
					<CustomFieldOptions
						...
						embeddedCreateOptionEle={
							<CreateCustomFieldOptionModal
								...
								handleSubmit={data => handleAddNewOptionItem(data, 'statuses')}
								triggerBtn={AddNewOptionBtn}
								action='create-new-project'
							/>
						}
